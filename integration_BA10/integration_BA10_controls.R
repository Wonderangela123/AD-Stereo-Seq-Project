...
my_list = list()
for (sample in samples_list[7:10]){
    print(sample)
...
SaveH5Seurat(combined, filename = "integrated_controls.h5Seurat", overwrite = TRUE)
Convert("integrated_controls.h5Seurat", dest = "h5ad", overwrite = TRUE)
